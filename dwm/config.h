...
static const char col_cyan[]        = "#04394f";

/*My custom color*/
static const char col_blue_bright[] = "#AFF7FB";
static const char col_blue_dark[] = "#1D3A66";
...
static const char *colors[][3]      = {
        /*               fg         bg         border   */
      [SchemeNorm] = { col_blue_bright, col_gray1, col_blue_dark },
      [SchemeSel]  = { col_blue_bright, col_cyan,  col_blue_bright },
};
...
/* tagging */
//static const char *tags[] = { ">_", "&_&",".www", "0o0", ">_<", "</>", };
...
screenshot
*/
static const char *screenshoot[] = {"scrot", "/home/inori/Pictures/Screenshot/%d-%m-%Y-%T-screenshot.jpg",NULL};
/*
volume up down
*/
